...
sidebar.setContent('<h1>Location Search Results Sidebar</h1></br> <p>Goal is eventually for this to open up displaying results after user searches for a location</p>');
